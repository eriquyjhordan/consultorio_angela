...
const visitSlice = createSlice({
    ...
    reducers: {
        ...
        updateValuesToEdit: (state: VisitStore, action: PayloadAction<any>) => {
            ...
            console.log('exchangeControlData', exchangeControlData)
            state.oniciolise = exchangeControlData.lamina_oniciolise;
            state.onicomicose = exchangeControlData.lamina_onicomicose;
            state.onicogrifose = exchangeControlData.lamina_onicogrifose;
            state.outros = exchangeControlData.outras_laminas;
            state.desconfortoText = exchangeControlData.observacoes;
